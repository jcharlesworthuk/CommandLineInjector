...
namespace CommandLineInjector.Lamar.Tests
{
    public class LamarContainerAdapterTests
    {
        [Fact]
        public void GetInstance_Should_Pass_To_Container()
        {
            ...
            var adapter = new LamarContainerAdapter(containerMock.Object, (config, commands) => config);
        ...
        public void Should_Return_Nested_Container()
        {
            // Arrange
            var containerMock = new Mock<IContainer>();
            var nestedContainer = Mock.Of<INestedContainer>();
            ...
            nested.ShouldBeOfType<LamarNestedContainerAdapter>();
        ...
        public void Should_Invoke_Extra_Configuration()
        {
            ...
            var adapter = new LamarContainerAdapter(containerMock.Object, (config, commands) =>
            {
                configCalled = true;
                return config;
            });
        ...
        public void Should_Allow_Null_Extra_Configuration()
        {
            ...
            var nestedContainer = Mock.Of<INestedContainer>();
            containerMock.Setup(x => x.GetNestedContainer()).Returns(nestedContainer);
            var adapter = new LamarContainerAdapter(containerMock.Object, null);
